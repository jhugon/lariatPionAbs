...
if __name__ == "__main__":
  ...
  fileConfigs = [
    ...
    #  'addFriend': ["friend","friendTree_ProtoDUNE_pion_3p5GeV_mono_3ms_mcc8.0_v2.root"],
    #  'name': "3p5GeV",
  ...
  histConfigs = [
    ...
    #},
    {
      ...
      'binning': [280,0,7000],
      'var': "P*1000",
      'cuts': "!process_primary && Mother == 1 && P>0.01 && abs(pdg) < 1000000",
    },
    {
      'name': "pSecondaryZoom",
      'xtitle': "Secondary particle |p| [MeV/c]",
    ...
    {
      'name': "pSecondaryProtons",
      'xtitle': "Secondary Proton |p| [MeV/c]",
      'ytitle': "Particles per MeV/c",
      'normToBinWidth': True,
      'binning': [280,0,7000],
      'var': "P*1000",
      'cuts': "!process_primary && Mother == 1 && P>0.01 && abs(pdg) < 1000000 && pdg==2212",
    },
    {
      'name': "pSecondaryProtonsZoom",
      'xtitle': "Secondary Proton |p| [MeV/c]",
      'ytitle': "Particles per MeV/c",
      'normToBinWidth': True,
      'binning': [100,0,3000],
    ...
    {
      'name': "pSecondaryProtonsNoPip",
      'xtitle': "Secondary Proton |p| [MeV/c]",
      'ytitle': "Particles per MeV/c",
      'normToBinWidth': True,
      'binning': [280,0,7000],
      'var': "P*1000",
      'cuts': "!process_primary && Mother == 1 && P>0.01 && abs(pdg) < 1000000 && pdg==2212 && nSecondaryPiPlus==0",
    },
    {
      'name': "pSecondaryPip",
      'xtitle': "Secondary #pi^{+} |p| [MeV/c]",
      'ytitle': "Particles per MeV/c",
      'normToBinWidth': True,
      'binning': [280,0,7000],
      'var': "P*1000",
      'cuts': "!process_primary && Mother == 1 && P>0.01 && abs(pdg) < 1000000 && pdg==211",
    },
    {
      'name': "pSecondaryPipZoom",
      'xtitle': "Secondary #pi^{+} |p| [MeV/c]",
      'ytitle': "Particles per MeV/c",
      'normToBinWidth': True,
      'binning': [100,0,3000],
    ...
    {
      'name': "pSecondaryPi0",
      'xtitle': "Secondary #pi^{0} |p| [MeV/c]",
      'ytitle': "Particles per MeV/c",
      'normToBinWidth': True,
      'binning': [280,0,7000],
      'var': "P*1000",
      'cuts': "!process_primary && Mother == 1 && P>0.01 && abs(pdg) < 1000000 && pdg==111",
    },
    {
      'name': "pSecondaryPi0Zoom",
      'xtitle': "Secondary #pi^{0} |p| [MeV/c]",
      'ytitle': "Particles per MeV/c",
      'normToBinWidth': True,
      'binning': [100,0,3000],
