...
#    },
  ...
  histConfigs = [
    {
      ...
      'var': "sqrt(Px*Px+Py*Py+Pz*Pz)*1000",
      'cuts': "process_primary",
      'efficiencyDenomCuts': "process_primary",
      'color': root.kBlack,
    },
    {
      'name': "n2cm",
    ...
    },
    {
      ...
      'binning': [100,0,1500],
      'var': "sqrt(Px*Px+Py*Py+Pz*Pz)*1000",
      'cuts': "process_primary && nTracksLengthLt5cm <= 2 && nTracksFirst14cm <= 3 && nTracksFirst2cm >= 1",
      'efficiencyDenomCuts': "process_primary",
      'color': root.kOrange-3,
    },
  ]
  plotManyHistsOnePlot(fileConfigs,histConfigs,c,"anatree/anatree",nMax=NMAX,outPrefix="Eff_")
  ...
  plotManyFilesOnePlot(fileConfigs,histConfigs,c,"anatree/anatree",nMax=NMAX,outPrefix="Eff_")
