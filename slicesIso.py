...
if __name__ == "__main__":
  ...
  for logy,xmax,outext,ytitle in [(False,4,"","Normalized--Hits")]:#,(True,10,"_logy","Hits/bin")]:
    ...
    plotSlices(c,f.Get("primTrkdEdxsVtrueStartPhi_UniformIsoMuon"),"Slices_trueStartPhi_UniformIsoMuon"+outext,[0,xmax],"dE/dx [MeV/cm]",ytitle,"#phi",rebinX=5,rebinY=10,xunits="deg",normalize=not logy)
