...
#    },
    ...
    },
    {
      ...
      'xtitle': "Primary TPC Track #theta_{zx} [deg]",
      'ytitle': "Events / bin",
      'binning': [180,-180,180],
      'var': "atan(tan(primTrkStartTheta)*cos(primTrkStartPhi))*180./pi",
      'cuts': weightStr,
      #'normalize': True,
      'logy': logy,
    },
    ...
    },
    {
      ...
      'xtitle': "Primary TPC Track #theta_{zy} [deg]",
      'ytitle': "Events / bin",
      'binning': [180,-180,180],
      'var': "atan(tan(primTrkStartTheta)*sin(primTrkStartPhi))*180./pi",
      'cuts': weightStr,
      #'normalize': True,
      'logy': logy,
    },
...
#    },
    ...
    },
    {
      ...
      'ytitle': "Events / bin",
      'binning': [180,-180,180],
      'var': "atan(tan(trueStartTheta)*cos(trueStartPhi))*180./pi",
      'cuts': weightStr,
      #'normalize': True,
      'logy': logy,
    },
    ...
    },
    {
      ...
      'ytitle': "Events / bin",
      'binning': [180,-180,180],
      'var': "atan(tan(trueStartTheta)*sin(trueStartPhi))*180./pi",
      'cuts': weightStr,
      #'normalize': True,
      'logy': logy,
    },
  ...
  plotOneHistOnePlot(fileConfigs,histConfigs,c,"cosmicanalyzer/tree",nMax=NMAX)
...
#    },
    ...
    },
    {
      ...
      'binning': [90,-180,180,90,0,180],
      'var': "acos(sin(primTrkStartTheta)*sin(primTrkStartPhi))*180/pi:atan(cos(primTrkStartPhi)*tan(primTrkStartTheta))*180/pi",
      'cuts': weightStr,
      #'normalize': True,
      'logz': False,
    },
    {
      ...
      'binning': [90,-180,180,90,0,180],
      'var': "acos(sin(primTrkStartTheta)*cos(primTrkStartPhi))*180/pi:atan(tan(primTrkStartTheta)*sin(primTrkStartPhi))*180/pi",
      'cuts': weightStr,
      #'normalize': True,
      'logz': False,
    },
...
#    },
    ...
    },
    {
      ...
      'binning': [90,-180,180,90,0,180],
      'var': "acos(sin(trueStartTheta)*sin(trueStartPhi))*180/pi:atan(cos(trueStartPhi)*tan(trueStartTheta))*180/pi",
      'cuts': weightStr,
      #'normalize': True,
      'logz': False,
    },
    {
      ...
      'binning': [90,-180,180,90,0,180],
      'var': "acos(sin(trueStartTheta)*cos(trueStartPhi))*180/pi:atan(tan(trueStartTheta)*sin(trueStartPhi))*180/pi",
      'cuts': weightStr,
      #'normalize': True,
      'logz': False,
    },
