...
#  cuts += "*( iBestMatch >= 0 && nMatchedTracks == 1)" # matching in analyzer
  ...
  fileConfigs = [
    ...
    {
      'fn': "/dune/app/users/jhugon/likelihoodPID/dunetpc_v06_33_01_01/srcs/dunetpc/dune/PionAna/pionana_pi4GeV.root",
      #'addFriend': ["friend", "friendTree_pip_v3.root"],
      #'fn': "/lariat/app/users/jhugon/lariatsoft_v06_15_00/srcs/lariatsoft/JobConfigurations/pip_piAbsSelector.root",
      'name': "pip4GeV",
      'title': "#pi^{+} 4 GeV MC",
  ...
  histConfigs = [
    {
      'name': "primTrkKins",
      'xtitle': "Kinetic Energy at Hits [MeV]",
      'ytitle': "Events / bin",
      'binning': [700,0,7000],
      'var': "primTrkKins",
      'cuts': weightStr,
    ...
    },
    {
      ...
      'xtitle': "Kinetic Energy at Interaction [MeV]",
      'ytitle': "Events / bin",
      'binning': [700,0,7000],
